package ex04conrtolstatement;

/*
 for문: while문과 같은 반복문으로 초기값, 조건식, 증감식이 한줄에 있어
 	반복의 횟수를 명시적으로 알수있는 반복문이다.
 	그러므로 사용빈도가 가장 높다.
 	형식]
 		for(초기값; 조건식; 증감식){
 			실행문장;
...
public class E05For {
	...
	public static void main(String[] args) {
		...
		/*
		 for문으로 무한로프 조건을 만들때 아래와 같이 사용한다.
...
//		}
		...
		/*
		 for문의 초기값을 외부(넓은 지역)에서 선언하면 해당변수는 for문안쪽(좁은지역)
		...
		for(int x=2 ; x<=9 ; x++) {
			for(int y=1 ; y<=9 ; y++) {
				System.out.printf(" %d*1=%2d ", x,x*y);
			}
			System.out.println();
		}
