...
/*
 추상클래스2 - 추상메소드를 포함한 클래스
	추상메소드를 멤버로 포함한 클래스는 반드시 abstract로 정의해야한다. class앞에 abstract를 지우면
	에러가 발생한다.
 */
...
/*
 	부모가 가진 추상메소드를 그대로 상속받게 되므로 에러가 나지 않으려면 해당클래스도 abstract로 선언하거나.
...
public class E01AbstractBasic {
	...
	public static void main(String[] args) {
		...
		((absClassChild2)absClass2).newMethod(); /*
			부모타입의 참조변수로 자식객체에 접근하려면 다운캐스팅(강제형변환) 후 접근해야한다.
			*/
		
		/*
		 추상클래스내에 선언된 정적멤버는 오버라이딩후 
		 */
