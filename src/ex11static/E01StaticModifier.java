...
class MyStatic{
	...
	/*
	 [인스턴스형 멤버메소드] 인스턴스형 메소드에서는 모든 멤버를 사용할 수 있다. 인스턴스형 변수,
	 정적변수 둘 다 가능.
	 */
	void instanceMethod() {
...
public class E01StaticModifier {
	...
	public static void main(String[] args) {
		...
		/*
		 방법2 : 인스턴수변수처럼 참조변수를 통해 접근할 수 있다.
		...
		/*
		 인스턴스 멤버변수를 객체별로 각각 존재하므로 아래 초기화된 값은 객체별로 각각 저장된다.
		...
		/*
		 정적 멤버메소드의 접근방법도 정젹 변수와 동일한 규칙을 가진다.
		 */
