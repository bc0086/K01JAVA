...
class MyClass {
	...
	/*
	 toString() : 실제 저장된 데이터가 반환되도록 Object클래스로부터 상속받아 오버라이딩한 메소드
	 */
	@Override
...
class Point{
	...
	/*
	 객체1, 2의 x,y 값을 동시에 비교해서 둘다 동일할 때 같은 객체로 판단하도록 오버라이딩 처리
	 */
	@Override
	public boolean equals(Object obj) {
...
public class E04Object3Equals {
	...
	public static void main(String[] args) {
		...
		/*
		 아래 toString() 메소드는 굳이 호출하지 않아도 print()문이 실행될때 자동으로 호출하므로,
		 아래 출력결과는 동일하다.
		 */
