...
public class E01WrapperClass2 {
	...
	public static void main(String[] args) {
		...
		/*
		 2] codePointAt() : 문자여렝서 index에 해당하는 한 문자의 아스키코드 값을 반환한다.
		 */
		...
		System.out.println(Character.isWhitespace('Z'));//true
		System.out.println(Character.isWhitespace('가'));//무조건 false
