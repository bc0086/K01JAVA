...
public class E02InnerStaticClass {
	...
	public static void main(String[] args) {
		...
		/*
		내부정적 클래스의 정적멤버에 접근할 때는 외부클래스의 객체 생성없이 클래스명으로 바로 
		 접근이 가능하다.
		 */
		...
		/*
		 내부정적클래스의 인스턴스멤버에 접근할때는 객체를 생성한 후 참조변수를 통해서 접근해야 한다.
		 */
		...
		/*
		 ...
		 외부클래스의 멤버변수(메소드)는 객체생성 후 참조변수를 통해 접근하다.
		 */
