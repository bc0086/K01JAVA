...
/*
 ...
 -RuntimeException 클래스 계열로 NullPointerException이 대표적인 하위클래스이다.
 -main메소드에서 무시하기 위해 throws 하더라도 오류가 발생되므로 반드시 예외처리를 해줘야 한다.
 -예외발생시 JVM은 해당 예외클래스를 인스턴스화해서 프로그램쪽으로 전달하게 되고 try~catch에서 
  받은후 처리한다.
 */
public class Ex02PreDefineException {
	...
	public static void main(String[] args) {
		...
		/*
		 3]InputMismatchException : 숫자를 입력해야 하는데 문자열을 입력할 때 발생되는 예외
		 */
...
/////////////////////////////////////////////////////////////////////
		...
		/*
		 4] NullPointerException
		 	: 인스턴스 변수네 참조값이 없는 상태에서 호출하면 발생되는 예외. 즉 참조변수만 생성되고,
	...
	/*
	 String 객체가 매개변수로 전달되면서 Object로 형변환되기 때문에, 여기서는 상속관계가 확인되어
	 true를 반환한다.
	 */
