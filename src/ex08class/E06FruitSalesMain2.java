...
class FruitSeller2
{
	...
	/*
	 ...
	 특성때문에 일반적인 멤버메소드내에서는 초기화 할 수 없다. 멤버메소드는 
	 개발자가 원할 때 언제든지 호출할 수 있기 때문에 상수의 특성과는 맞지 않기 
	 떄문이다.
	 */
...
class FruitBuyer2 
{
	...
	/*
	 초기화메소드
	 	: 멤버변수를 초기화할때 사용한다. 2차버전에서는 생성자대신
	 	사용되고 있으며, 객체 초기화시 여러줄에 걸쳐 코딩해야 하는
	 	번거로움을 간편하게 해결할 수 있다.
	 */	
...
public class E06FruitSalesMain2 
{
	public static void main(String[] args) 
	{
		...
		/*
		 ...
		 수 있게 되었다.
		 아래에서는 판매단가와 재고가 서로 다른 2개의 판매자 객체를
		 생성한다.
		 */
		//판매자1
