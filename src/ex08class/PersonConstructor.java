...
/*
 ...
 용도1 : 동일 클래스내에서 다른 생성자를 호출할 때 사용한다.
 		...
 		사용법 :
 			this(인자1, 인자2.....);
 용도2 : 생성자내에서 멤버변수와 매개변수의 이름이 동일할 때 구분하기 위해 사용
 		this.변수 -> 멤버변수
 		변수 -> 생성자의 매개변수
 		단. 이름이 서로 다르다면 this는 생략해도 된다. 주로 명시적인
 		코드작성을 위해 사용된다.
 */
...
public class PersonConstructor {
	...
	/*
	 디폴트생성자
	 	: 해당 클래스에 생성자를 정의하지 않은 경우에 아래와 같은 매개변수. 실행부가 없는
	 	생성자가 자동으로 삽입된다. 단, 생성자를 하나라도 정의하면 디폴트 생성자는
	 	삽입되지 않는다.(주의)
	 */
