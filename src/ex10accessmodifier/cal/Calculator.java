...
/*
 Calculator 클래스는 해당 java파일에서 외부에 가장 의미있는 클래스로써 public으로 선언되었다.
...
public class Calculator {
	...
	/*
	 생성자메소드
	 	: 해당 클래스의 객체가 생성될때 덧셈, 뺄셈을 위한 클래스의 객체도 동시에 생성된다.
	 */
	public Calculator()
	{
		adder = new Adder();
	...
	/*
	 멤버메소드
	 	: 덧셈 혹은 뺄셈 연산후 결과를 반환하는 메소드로, 각 연산을 위해 해당 default클래스의 
	 	멤버메소드를 호출한 후 결과를 반환받는다.
	 */
