package ex10accessmodifier.copy;
...
public class E01AccessModifierMain {
	...
	public static void main(String[] args) 
	{
		...
		/*
		 private으로 선언된 멤버는 동일한 패키지라 할지라고 접근이 불가능하다.
		 해당멤버는 동일 클래스 내에서만 접근을 허용한다.
		 
		 ※private으로 선언된 멤버를 외부클래스에서 접근할 때는 주로 public으로 선언된
		...
		/*
		 동일한 패키지에 선언된 클래스므로 import없이 객체생성 및 접근이 가능하다.
		 */
		...
		/*
		 다른패키지에 선언된 클래스이므로 객체생성을 위해서는 import가 필요하다.
		...
		/*
		 다른패키지에 정의된 디폴트 클래스이므로 객체생성이 불가능하다.
